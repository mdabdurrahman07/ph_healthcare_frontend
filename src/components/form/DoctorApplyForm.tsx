...
import { doctorApplicationSchema, isAcceptedFileSize, isAcceptedFileType, MAX_ADDITIONAL_FILES, MAX_FILE_SIZE } from '@/validations';
import { formatFileSize } from '@/utils/fileSize.utils';
import Link from 'next/link';
import { useRouter } from 'next/navigation';
import { useApplyAsDoctor } from '@/hooks/auth';
import { DoctorApplicationData } from '@/types/doctor/doctor.type';
