...
import { PublicDoctorParams } from "@/types/doctor/doctor.type";
import { useSuspenseGetPublicDoctors } from "@/hooks/auth";
import Link from "next/link";

export const PublicDoctorList = () => {
  ...
  return (
    <div>
      <Suspense fallback={<PublicDoctorListLoading />}>
        <DoctorList {...queryParams} onPageChange={setPage} />
      </Suspense>
    </div>
  );
};
